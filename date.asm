 ...
 3f9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 570:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 575:	bb 18 07 00 00       	mov    $0x718,%ebx
...
free(void *ap)
{
 ...
 581:	a1 14 0a 00 00       	mov    0xa14,%eax
{
 ...
 5bf:	5b                   	pop    %ebx
  freep = p;
 5c0:	a3 14 0a 00 00       	mov    %eax,0xa14
}
 5c5:	5e                   	pop    %esi
 5c6:	5f                   	pop    %edi
 5c7:	5d                   	pop    %ebp
 ...
 5d6:	72 ce                	jb     5a6 <free+0x26>
{
 ...
 5f7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 5fa:	a3 14 0a 00 00       	mov    %eax,0xa14
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 15 14 0a 00 00    	mov    0xa14,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65b:	3b 05 14 0a 00 00    	cmp    0xa14,%eax
 ...
 67e:	e8 fd fe ff ff       	call   580 <free>
  return freep;
 683:	8b 15 14 0a 00 00    	mov    0xa14,%edx
 ...
 6ac:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6af:	89 15 14 0a 00 00    	mov    %edx,0xa14
}
 ...
 6bf:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6c0:	c7 05 14 0a 00 00 18 	movl   $0xa18,0xa14
 6c7:	0a 00 00 
    base.s.size = 0;
 6ca:	b8 18 0a 00 00       	mov    $0xa18,%eax
    base.s.ptr = freep = prevp = &base;
 6cf:	c7 05 18 0a 00 00 18 	movl   $0xa18,0xa18
 6d6:	0a 00 00 
    base.s.size = 0;
 6d9:	c7 05 1c 0a 00 00 00 	movl   $0x0,0xa1c
 6e0:	00 00 00 
    if(p->s.size >= nunits){
